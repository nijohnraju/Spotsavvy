...
static const CameraPosition initialCameraPosition = CameraPosition(target: LatLng(37.15478, -122.78945), zoom: 14.0);
Set<Marker> markers = {};
...
//static const CameraPosition targetPosition = CameraPosition(target: LatLng(33.15478, -135.78945), zoom: 14.0, bearing: 192.0,tilt: 60);
  ...
  Widget build(BuildContext context) {
        return Scaffold(
      appBar: AppBar(backgroundColor: greensavvy, title: const Text('Book A Parking Spot'), centerTitle: true),
     body: GoogleMap(
      ...
      floatingActionButton: FloatingActionButton.extended(
       onPressed: () async{
        ...
        markers.clear();
        markers.add(Marker(markerId: MarkerId('currentLoction'),position:  LatLng(position.latitude,  position.longitude) ));
        setState(() {});
       },
